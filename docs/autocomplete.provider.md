...
| 4     | domain expert   | authoritative for one language or domain, from knowledge specific to it                                 | `autocomplete-css`, `autocomplete-html`, `autocomplete-jedi`, `autocomplete-lumine`, `autocomplete-sofistik`, `color-inline` |
